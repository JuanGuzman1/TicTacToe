...
export default function App() {
  ...
  const onPress = (rowIndex, columnIndex) => {
    if (map[rowIndex][columnIndex] !== "") {
      Alert.alert("Position already taken");
      return;
    }
    setMap((existingMap) => {
  ...
  const botTurn = () => {
    ...
    if (gameMode === "BOT_MEDIUM") {
      ...
      if (!chosenOption) {
        //Defend
        //Check if the oponent WINS if it takes one of the possible positions
        possiblePositions.forEach((possiblePosition) => {
          const mapCopy = copyArray(map);
      ...
      <ImageBackground source={bg} style={styles.bg} resizeMode="contain">
        ...
        <View style={styles.buttons}>
          <Text
            ...
            style={[
              styles.button,
              { backgroundColor: gameMode === "LOCAL" ? "#4f5686" : "#242D34" },
            ]}
          >
            Local
          </Text>
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_EASY" ? "#4f5686" : "#242D34",
              },
            ]}
          >
            Easy Bot
          ...
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_MEDIUM" ? "#4f5686" : "#242D34",
              },
            ]}
          >
            Medium Bot
